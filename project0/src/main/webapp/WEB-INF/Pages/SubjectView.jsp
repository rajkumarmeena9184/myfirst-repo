						...
						<c:choose>
							<c:when test="${form.id==0}">
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #C71585;">
									<s:message code="label.addsubject"></s:message>
								</h4>
							</c:when>
							<c:otherwise>
								<h4 class="card-title text-center mb-4 mt-1"
						...
						<div class="form-group">
							<div align="left" style="color: #8A2BE2;"
								...
								<sf:label path="">
									...
									<s:message code="label.entersubjectname" var="subjectname"></s:message>
						...
						<div class="form-group">
							<div align="left" style="color: #8A2BE2;"
								...
								<sf:label path="">
									...
									<s:message code="label.enterdescription" var="description"></s:message>
									<span style="color: red">*</span>
								</sf:label>
							</div>
							<div class="input-group">
