				...
				<sf:form class="register-form" method="post" modelAttribute="form">
					...
					<c:if test="${!empty list}">
						<div class="row p-2 d-flex justify-content-center">
							<div class="col-lg-3">
								<s:message code="label.entersubjectname" var="enterSubjectName" />
								<sf:input path="name" cssClass="form-control border-left-right"
									placeholder="${enterSubjectName}" />
							</div>
									...
									<thead class="bg-dark">
										<tr>
											...
											<th scope="col" class="text-center text-white"><s:message
													code="label.SNo" /></th>
											<th scope="col" class="text-center text-white"><s:message
													code="label.subject" /></th>
											<th scope="col" class="text-center text-white"><s:message
													code="label.course" /></th>
											<th scope="col" class="text-center text-white"><s:message
										...
										<c:forEach items="${list}" var="subject" varStatus="ct">
											<tr>
												<td class="text-center"><input class="checkbox"
													name="chk_1" type="checkbox" value="${subject.id}"></td>
												...
												<td class="text-center"><c:url var="editUrl"
													...
													name="operation" href="${editUrl}${subject.id}"><i
