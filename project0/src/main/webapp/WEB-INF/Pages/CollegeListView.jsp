				...
				<sf:form class="register-form" method="post" modelAttribute="form">
					...
					<c:if test="${!empty list}">
						<div class="row p-2 d-flex justify-content-center">
							<div class="col-lg-3">
								<s:message code="label.entercname" var="enterCollegName" />
								<sf:input path="name" cssClass="form-control border-left-right"
									placeholder="${enterCollegName}" />
							</div>

							<div class="col-lg-3">
								<s:message code="label.entercity" var="enterCity" />
								<sf:input path="city" cssClass="form-control border-left-right"
										...
										<c:forEach items="${list}" var="college" varStatus="ct">
											<tr>
												<td class="text-center"><input class="checkbox"
													name="chk_1" type="checkbox" value="${college.id}"></td>
												...
												<td class="text-center">${college.phonNo}</td>
												<%-- <td><fmt:formatDate value="${student.dob}" type="date"
												...
												<td class="text-center"><c:url var="editUrl"
													...
													name="operation" href="${editUrl}${college.id}"><i
